...
public class QuestionAnswerFragment extends Fragment implements NativeAdListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if(getActivity()!=null){
           NativeAd nativeAd=new NativeAd(getActivity(), getActivity().getString(R.string.placement_id));
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(isNetworkAvailable()){
            if(uid!=null){
                ...
                adapter=new QuestionAnswerRecyclerAdapter(getActivity(), list,uid);
        ...
        if(uid!=null) {
            ...
            query.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if(task.isSuccessful()){
                        ...
                        if(list!=null&&list.size()==0){
                            ...
                            String status=getString(R.string.user_donot_answer_question);
                ...
                public void onFailure(@NonNull Exception e) {
                    progressCard.setVisibility(View.GONE);
                    Toast.makeText(getActivity(), "Can't proceed at this time,try again ", Toast.LENGTH_SHORT).show();
